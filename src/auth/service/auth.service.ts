...
export class AuthService {
  ...
  public async register({
    ...
    this.logger.log('Call AuthService method ' + this.register.name);

    let auth: Auth = await this.repository.findOne({ where: { email } });

    if (auth) {
      this.logger.error('E-mail already exists');
  ...
  public async login({
    ...
    this.logger.log('Call AuthService method' + this.login.name);
  ...
  public async validate({
    ...
    this.logger.log('Call AuthService method ' + this.validate.name);
